...
router.get('/delete-category', verifyManagerAuth, managerController.getAllCategories);
router.post('/delete-category', verifyManagerAuth, managerController.deleteCategory);

router.get('/delete-items',verifyManagerAuth,managerController.getItemsDeletePage);
router.post('/delete-items',verifyManagerAuth,managerController.postDeleteItems)
